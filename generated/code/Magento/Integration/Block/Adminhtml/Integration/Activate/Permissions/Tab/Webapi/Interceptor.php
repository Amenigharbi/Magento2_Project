...
class Interceptor extends \Magento\Integration\Block\Adminhtml\Integration\Activate\Permissions\Tab\Webapi implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEverythingAllowed');
        return $pluginInfo ? $this->___callPlugins('isEverythingAllowed', func_get_args(), $pluginInfo) : parent::isEverythingAllowed();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getResourcesTreeJson');
        return $pluginInfo ? $this->___callPlugins('getResourcesTreeJson', func_get_args(), $pluginInfo) : parent::getResourcesTreeJson();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedResourcesJson');
        return $pluginInfo ? $this->___callPlugins('getSelectedResourcesJson', func_get_args(), $pluginInfo) : parent::getSelectedResourcesJson();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTreeEmpty');
        return $pluginInfo ? $this->___callPlugins('isTreeEmpty', func_get_args(), $pluginInfo) : parent::isTreeEmpty();
    }
