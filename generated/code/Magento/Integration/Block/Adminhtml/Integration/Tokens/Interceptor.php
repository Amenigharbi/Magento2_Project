...
class Interceptor extends \Magento\Integration\Block\Adminhtml\Integration\Tokens implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormFields');
        return $pluginInfo ? $this->___callPlugins('getFormFields', func_get_args(), $pluginInfo) : parent::getFormFields();
    }
