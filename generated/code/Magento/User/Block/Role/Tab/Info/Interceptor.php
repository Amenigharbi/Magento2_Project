...
class Interceptor extends \Magento\User\Block\Role\Tab\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_beforeToHtml');
        return $pluginInfo ? $this->___callPlugins('_beforeToHtml', func_get_args(), $pluginInfo) : parent::_beforeToHtml();
    }
