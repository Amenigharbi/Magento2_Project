...
class Interceptor extends \Magento\User\Block\Role\Tab\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCoreRegistry');
        return $pluginInfo ? $this->___callPlugins('setCoreRegistry', func_get_args(), $pluginInfo) : parent::setCoreRegistry($coreRegistry);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCoreRegistry');
        return $pluginInfo ? $this->___callPlugins('getCoreRegistry', func_get_args(), $pluginInfo) : parent::getCoreRegistry();
    }
    ...
    public function getSelectedResources()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSelectedResources', func_get_args(), $pluginInfo) : parent::getSelectedResources();
    }
