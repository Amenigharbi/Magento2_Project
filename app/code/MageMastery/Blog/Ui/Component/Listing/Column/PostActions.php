...
class PostActions extends Column
{
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['entity_id'])) {
                    ...
                    $title = $this->escaper->escapeHtml($item['region_id']);
                    $item[$name]['delete'] = [
    ...
    {
        return $this->urlBuilder->getUrl(self::URL_PATH_EDIT, ['entity_id' => $item['entity_id']]);
    }
    ...
    {
        return $this->urlBuilder->getUrl(self::URL_PATH_DELETE, ['entity_id' => $item['entity_id']]);
    }
}
