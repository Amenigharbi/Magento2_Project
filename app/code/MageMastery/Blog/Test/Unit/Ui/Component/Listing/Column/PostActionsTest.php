...
class PostActionsTest extends TestCase
{
    ...
    public function testPrepareDataSourceLinks(): void
    {
        ...
        $this->urlBuilder
            ->method('getUrl')
            ->withConsecutive(
                [$this->equalTo('magemastery_blog/post/edit'), $this->equalTo(['entity_id' => 1])],
                [$this->equalTo('magemastery_blog/post/delete'), $this->equalTo(['entity_id' => 1])],
                [$this->equalTo('magemastery_blog/post/delete'), $this->equalTo(['entity_id' => 1])],
                [$this->equalTo('magemastery_blog/post/edit'), $this->equalTo(['entity_id' => 2])],
                [$this->equalTo('magemastery_blog/post/delete'), $this->equalTo(['entity_id' => 2])],
            )
            ->willReturnOnConsecutiveCalls(
                'magemastery_blog/post/edit/entity_id/1',
                'magemastery_blog/post/delete/entity_id/1',
                'magemastery_blog/post/edit/entity_id/2',
                'magemastery_blog/post/delete/entity_id/2',
            );
